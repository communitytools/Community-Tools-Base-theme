  ...
  Drupal.color = {
    ...
    callback: function(context, settings, form, farb, height, width) {
      ...
      */
      ...
      $('#preview-header, #preview-logo-area, #preview-menu', form).css('background-color', $('#palette input[name="palette[base]"]', form).val());
      ...
      $('#preview-footer a', form).css('color', $('#palette input[name="palette[footerlinks]"]', form).val());
